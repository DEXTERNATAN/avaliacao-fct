...
export class ResetSenhaComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder,
        ...
        this.resetForm = this.fb.group({
            ...
            senhaAtual: this.fb.control(null, [Validators.required, Validators.maxLength(25)]),
            senhaNova: this.fb.control(null, [Validators.required, Validators.maxLength(25)]),
            senhaNovaConfirmacao: this.fb.control(null, [Validators.required, Validators.maxLength(25)])
        }, {
