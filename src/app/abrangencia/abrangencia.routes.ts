...
const abrangenciaRoutes: Routes = [
 { path: 'abrangencia', component: AbrangenciaComponent, pathMatch: 'full', canLoad: [ LoggedInGuard ], canActivate: [ LoggedInGuard ] },
  { path: 'abrangencia/novo', component: AbrangenciaFormComponent, canLoad: [ LoggedInGuard ] },
  { path: 'abrangencia/:id_abrangencia', component: AbrangenciaFormComponent, canLoad: [ LoggedInGuard ]}
];
